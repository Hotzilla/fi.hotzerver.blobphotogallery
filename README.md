...
Name the featured album folder with a `main-` prefix (for example, `main-hääpäivä/`). The first matching folder is moved to the top and highlighted as the main gallery; all remaining albums keep their normal alphabetical order.
